...
const POINTS: { Icon: LucideIcon; label: string; desc: string }[] = [
  { Icon: Rows3, label: '원페이지 구성', desc: '한 페이지 안에 모든 섹션을 담음' },
  { Icon: Anchor, label: '헤더 앵커 이동', desc: '메뉴 클릭 시 해당 섹션으로 스르륵 스크롤' },
    ...
    <section style={{ background: '#fff', padding: 'clamp(3rem, 7vw, 5.5rem) 1.25rem' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ marginBottom: 'clamp(2rem, 5vw, 3rem)' }}>
          <span className="footnote emphasized c-accent">03 · 랜딩형 홈페이지란</span>
        ...
        <div className="lhd-split">
          ...
          <div className="lhd-text">
            ...
            <p className="body" style={{ margin: '0.5rem 0 1.75rem', wordBreak: 'keep-all' }}>
              여러 페이지로 흩어지지 않고, <strong>한 페이지 안에 모든 섹션</strong>을 담은 홈페이지예요.
              <br />
              상단 메뉴를 누르면 해당 섹션으로 이동하며, 소개부터 문의까지 한 흐름으로 이어집니다.
            </p>
