...
const ITEMS = [
  ...
  { href: KAKAO_URL, label: '카카오톡 문의', icon: MessageCircle, external: true, color: '#FEE500', whiteLines: false, textColor: '#3C1E1E' },
...
export default function BottomBar() {
  ...
  return (
    <nav className="bottom-action-bar">
      {ITEMS.map(({ href, label, icon: Icon, external, tel, color, whiteLines, textColor }) => {
