...
export const categoryOrder = [
  ...
  '의료/병원', '뷰티/미용', '학원/교육', '음식점/카페', '법률/세무', '부동산', '쇼핑몰',
]
...
export const portfolios: Portfolio[] = [
  ...
  },
  {
    ...
    category: '쇼핑몰',
    plan: '홈페이지',
    desc: '셀렉션 소개 편집샵 홈페이지',
    url: '',
    images: ['/images/cases/samples/sample-shop-3.webp'],
    placeholder: true,
  },
  {
    slug: 'sample-shop-4',
    ...
    category: '쇼핑몰',
    plan: '홈페이지',
    desc: '리빙 제품 카탈로그 홈페이지',
    url: '',
    images: ['/images/cases/samples/sample-shop-4.webp'],
    placeholder: true,
  },
]
